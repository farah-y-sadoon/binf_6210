...
gene_classifier <- randomForest::randomForest(x = dfTraining[, 86:88], y = base::as.factor(dfTraining$markercode), ntree = 50, importance = TRUE)
...
# See additional script for question 12 in-class activity in the same directory for the response.
